<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminTSGUpdate.aspx.cs" Inherits="AdminTSGUpdateDBsecond.AdminTSGUpdate" %>
...
<body>
    ...
    <table>
        ...
        <tr>
		    ...
		    <td style="width: 150px; vertical-align: text-top;"  ="top"><PFWEB:ADMINMENU id="AdminMenu" selectedLabel="InventoryOverview" runat="server"></PFWEB:ADMINMENU></td>
