<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminTSGUpdateSeries.aspx.cs" Inherits="AdminTSGUpdateSeries.AdminTSGUpdateSeries" %>
...
<body>
    ...
    <table>
        <tr>
            <td colspan="2"><PFWEB:ADMINHEADER id="AdminHeader" runat="server"></PFWEB:ADMINHEADER></td>
        </tr>
        <tr>
